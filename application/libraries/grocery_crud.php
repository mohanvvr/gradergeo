...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	{   
		if($field_info->extras == 'text_editor')
		{
			...
			$this->set_js($this->default_texteditor_path.'/ckeditor.js');
			$this->set_js($this->default_javascript_path.'/_samples/sample.js');
			$input = "<textarea name='{$field_info->name}' class='ckeditor' >$value</textarea>";
		}
		else
		{
